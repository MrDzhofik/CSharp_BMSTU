namespace lab12
{
    public partial class Form1 : Form
    {
        ...
        {
            sender.GetType().GetProperty("Text").SetValue(sender, figure[player % 2]);
            sender.GetType().GetProperty("Enabled").SetValue(sender, false);
            player++;
            string temp = Convert.ToString(2 - player % 2);
            label1.Text = @"Текущий ход: Игрок " + temp;
            checkWin();
        }
        ...
        {
            MessageBox.Show("Много тыкать тоже не надо!");
        }
